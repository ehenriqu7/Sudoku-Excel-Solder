...
algorithm:
  ...
  The result the the intersection of these three sets.
  The get_hints method will return a list of possible solutions, ordered by length. This makes the final solver
...
def get_list_of_hints(su):
    """
    Get a list of hints sorted by number of hints per cell
    :param su: sudoku matrix
    :return: list of hints sorted by number of hints per cell
    """
...
def get_len_of_hints(hints):
    """
    calculate the number of hints per cell
    :param hints: array with possiblehints per cell
    :return: array with number of hints per cell (x,y)
    """
    global sudoku_size
...
def sorted_list(hints):
    """
    create a list of hints (dictionaries), based on the hints array
    :param hints:
    :return: a list of hints (dictionaries), based on the hints array
    """
    smallest_list = []
...
def print_sudoku(sudoku):
    """
    Small method to print a sudoku matrix in a more visible way. Found in the web
...
def solve(sudoku):
    """
    Sudoku Solver using recurrence
    :rtype: sudoku iteration matrix
    """
    global nr_loops
    nr_loops += 1
    if 0 not in sudoku:
...
def write_result_to_file(sudoku, my_file):
    """
    Write a sudoku matrix into a text file, comma separated
    :param sudoku: sudoku matrix to write
    :param my_file: file name to write
    :return: True / False if write is successfull or not
    """
    try:
